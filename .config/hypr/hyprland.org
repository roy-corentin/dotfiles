...
#+begin_src conf
  ...
  windowrule = tag +floating-window, class:^kitty$, title:^(float-.*)$
  ...
  windowrule = tag +floating-window, class:(blueberry.py|org.gnome.NautilusPreviewer|com.gabm.satty|About|TUI.float)
  ...
  # Emacs
  windowrule = float,class:^(emacs)$,title:^(Ediff.*)$
  windowrule = size 780 410,class:^(emacs)$,title:^(Ediff.*)$
  windowrule = move onscreen 100%-w-20,class:^(emacs)$,title:^(Ediff.*)$
  windowrule = float,class:^(emacs)$,title:^(emacs-float)$
  ...
  windowrule = move 100%-w-70 100%-w-45, title:WebcamOverlay # There's a typo in the hyprland rule so 100%-w on the height param is actually correct here
