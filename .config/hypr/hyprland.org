...
** Polkit
Start a graphical authentication agent. The system =polkitd= daemon is managed separately.
#+begin_src lua
...
** Network-Manager
Make sure you have installed =network-manager-applet=
#+begin_src lua :tangle no
