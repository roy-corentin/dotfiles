...
#+begin_src conf
  gestures {
      ...
      gesture = 3, up, cursorZoom, 1.6, mult
      gesture = 3, down, cursorZoom, 0.625, mult
   }
#+end_src
...
#+begin_src conf
  ...
  windowrule = tag +floating-window, match:class (xdg-desktop-portal-gtk|sublime_text|DesktopEditors|org.gnome.Nautilus|waypaper|brave-browser|zen), match:title ^(Open.*Files?|Open [F|f]older.*|Save.*Files?|Save.*As|Save|All Files|.*wants to [open|save].*|[C|c]hoose.*)
