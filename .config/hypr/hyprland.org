...
#+begin_src conf
  ...
  windowrulev2 = workspace 4,class:^Pop$

  # File Managers
  windowrulev2 = float,class:^(org.kde.dolphin|thunar)$
  ...
  windowrulev2 = move onscreen 100%-w-20,class:^(zen)$,title:^(Picture-in-Picture)$
  ...
  # Teams
  windowrulev2 = workspace 1,class:^(.*Microsoft Teams.*)$
  windowrulev2 = workspace 1,class:^(teams-for-linux)$

  # Discord
  windowrulev2 = workspace 1,class:^(discord|WebCord)$

  # Slack
  windowrulev2 = workspace 1,class:^(Slack)$

  # All
  windowrulev2 = opacity 0.94 override 0.94 override,class:^(.*)$
  windowrulev2 = opaque 1,class:^(.*)$
  windowrulev2 = opaque 0,class:^(emacs|kitty|Alacritty|com.mitchellh.ghostty)$
#+end_src
