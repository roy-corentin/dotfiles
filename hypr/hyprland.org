...
exec-once=swww init
exec=swww img ~/.config/hypr/wallpapers/livepixelart.gif
#+end_src
...
** Sleep
#+begin_src conf
exec-once=swayidle -w timeout 200 scripts/lockscreen
exec-once=swayidle -w before-sleep scripts/lockscreen
#+end_src
