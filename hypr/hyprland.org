...
- [[#startup][STARTUP]]
  ...
  - [[#polkit][Polkit]]
  - [[#exec-process-on-specific-workspace][Exec process on specific workspace]]
  - [[#wallpaper][Wallpaper]]
...
bind=ALT,U,movetoworkspace,6
bind=ALT,I,movetoworkspace,7
bind=ALT,O,movetoworkspace,8
...
** Exec process on specific workspace
#+begin_src conf
# exec-once = [workspace 1 silent;noanim] firefox
# exec-once = [workspace 2 silent;noanim] wezterm
